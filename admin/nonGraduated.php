...
?>
<div class="container">
    <h2 class="text-center" >Non - Graduated Participants List</h2>
    <?php
    ...
    $select_query = "SELECT registration_number from register WHERE graduated = 'no'";
    ...
    $sql = "SELECT * FROM register WHERE graduated = 'no'";
    $counter = 1;
